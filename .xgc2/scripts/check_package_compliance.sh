...
printf '%s  %s\n' \
  ...
  82a1b42d2659942ac90a3237542e68c498fac0948d2ae98749ecc2295d328b94 meshes/wheel_shaft.STL \
  1c80e0eb514842ed6e36d5d8935f321024e7d122caf9ac7e47d49afb8760784f urdf/mecanum_visual.urdf >"${expected_hashes}"
sha256sum meshes/*.STL urdf/mecanum_visual.urdf | sort >"${actual_hashes}"
